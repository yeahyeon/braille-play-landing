...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const mailtoLink = `mailto:contact@logncoding.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`)}`;
      ...
      <div className="container">
        <div className="contact-card">
          ...
          <div className="contact-title">
            <h2>Contact Us</h2>
            <p>Get in touch with us for any questions or support regarding Braille Play.</p>
          </div>
